...
public class DsqlRdsUtility implements IamTokenUtility {

  private DsqlUtilities utilities = null;

  public DsqlRdsUtility() {}

  @Override
  public String generateAuthenticationToken(@NonNull AwsCredentialsProvider credentialsProvider,
      @NonNull Region region, @NonNull String hostname, int port, @NonNull String username) {
